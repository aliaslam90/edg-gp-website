...
import imgCEO from "@/assets/4738369dabf096199f374956d2410fe7d923ac7c.png";
  ...
  return (
    <section className="bg-white py-[56px] lg:py-[72px] px-6 sm:px-8 lg:px-[80px] overflow-hidden">
      <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        {/* Left: Portrait Image — same layout as Chairman Message */}
        <motion.div
        ...
        {/* Right: Content — same structure as Chairman Message */}
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
