        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[72px] items-end">
          ...
          >
            <div className="flex flex-col gap-[19px]">
              {regions.map((region) => (
                <div key={region} className="flex items-center gap-[11px]">
                  ...
                  <span className="font-sans font-medium text-[12px] lg:text-[13px] text-white uppercase leading-[20px]">
                    {region}
                  </span>
                </div>
              ))}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-[#ceae5a] border border-[#ceae5a] px-[20px] py-[8px] rounded-[8px] font-sans font-medium text-[13px] lg:text-[14px] text-white leading-[22px] transition-all w-fit uppercase"
            >
              Our Market Presence
            </motion.button>
          </motion.div>
