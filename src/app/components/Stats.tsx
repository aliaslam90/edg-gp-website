  ...
  return (
    ...
    >
      <div className="flex flex-col gap-[40px] lg:gap-[52px] w-full">
        <h3 className={`text-[13px] lg:text-[15px] font-normal tracking-[-0.3px] leading-[20px] ${isDark ? "text-white" : "text-black"} font-sans`}>
          {title}
        </h3>
        <div className="flex items-end justify-between w-full">
          ...
          <span className={`text-[28px] sm:text-[34px] lg:text-[48px] leading-none font-normal tracking-[-2px] lg:tracking-[-2.5px] ${isDark ? "text-white" : "text-black"} font-sans`}>
            {value}
          </span>
        </div>
      </div>
