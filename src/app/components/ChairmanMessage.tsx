...
export const ChairmanMessage = () => {
  return (
    <section className="bg-white py-[72px] lg:py-[100px] px-6 sm:px-8 lg:px-[80px] overflow-hidden">
      <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        ...
        <motion.div
          ...
          className="flex-1 flex flex-col gap-[42px]"
        >
          {/* Quote Icon + Label + Heading */}
          <div className="flex flex-col gap-[17px]">
            <div className="h-[48px] lg:h-[64px] w-auto aspect-[97/64] opacity-60">
            ...
            <div className="flex flex-col gap-[10px]">
              <span className="text-[#ceae5a] text-[18px] lg:text-[24px] font-medium font-['Plus_Jakarta_Sans']">
                Chairman's Message
              </span>
              <h2 className="text-[28px] md:text-[36px] lg:text-[50.4px] font-bold text-black leading-[1.2] font-['Plus_Jakarta_Sans']">
                Charting Growth.<br />
          ...
          {/* Body Text */}
          <div className="text-[#555] text-[15px] lg:text-[18px] leading-[27px] font-normal font-['Plus_Jakarta_Sans'] tracking-[-0.18px] space-y-6">
            <p>
          ...
          <div className="flex flex-col gap-0.5 text-[#555] font-['Plus_Jakarta_Sans'] leading-[27px] tracking-[-0.18px]">
            <p className="text-[15px] lg:text-[18px] font-normal">Warm regards,</p>
            <p className="text-[18px] lg:text-[22px] font-semibold text-black">Chief Executive Officer</p>
            <p className="text-[15px] lg:text-[18px] font-normal text-[#ceae5a]">EDG Gold &amp; Petroleum</p>
          </div>
        </motion.div>
      </div>
    </section>
