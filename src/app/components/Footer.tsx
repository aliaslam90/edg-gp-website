...
export const Footer = () => {
  return (
    <footer className="bg-black relative overflow-hidden text-white pt-[80px] pb-[40px] px-[45px]">
      ...
      <div className="max-w-[1920px] mx-auto relative z-10">
        {/* Main Footer Content */}
        <div className="flex flex-col lg:flex-row justify-between gap-[60px] mb-[80px]">
          
          {/* Column 1: Logo */}
          <div className="shrink-0">
            <div className="w-[137px] h-[149px]">
          ...
          <div className="flex flex-col gap-[33px] min-w-[300px]">
            <h4 className="text-[20px] font-bold text-white tracking-tight font-['Plus_Jakarta_Sans']">Quick Links</h4>
            <div className="flex gap-[40px] text-white/80 font-['Plus_Jakarta_Sans'] text-[14px] font-medium leading-[24px]">
          ...
          <div className="flex flex-col gap-[33px] max-w-[300px]">
          ...
          {/* Column 4: Stay Tuned */}
          <div className="flex flex-col gap-[36px] min-w-[400px]">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between border-b border-white/60 pb-2">
                <input 
                  ...
                  className="bg-transparent border-none outline-none text-[17px] font-normal placeholder:text-white/60 w-full"
                />
              ...
              <div className="flex items-center gap-[13px]">
                <div className="w-[14px] h-[14px] border border-white rounded-[1px] cursor-pointer" />
                <span className="text-[15px] text-white/80 tracking-tight">
        ...
        {/* Footer Bottom Bar */}
        <div className="pt-6 border-t border-white/20 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-1.5 text-[16px] text-white font-normal">
            <span>© 2025</span>
          ...
          <div className="flex items-center gap-[15px]">
            {[
              ...
              <a 
                key={idx} 
                href="#" 
                className="w-[50px] h-[50px] bg-black/50 rounded-[5px] flex items-center justify-center hover:bg-[#CEAE5A]/20 transition-all border border-white/5"
              >
